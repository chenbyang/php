<html>
    <head><title>明新科技大學資訊管理系</title> //網頁的標題
    <meta charset="utf-8">
    <link href="https://cdn.bootcss.com/flexslider/2.6.3/flexslider.min.css" rel="stylesheet"> //導入外部css
    <script src="https://cdn.bootcss.com/jquery/2.2.2/jquery.min.js"></script> //外部javascript文件與代碼
    ...
    <body>
        ...
        <div class="bulletin">
           <h1>最新公告</h1>
            <?php
                $conn=mysqli_connect("db4free.net", "immust", "immustimmust", "immust"); //資料庫的連線
                $result=mysqli_query($conn, "select * from bulletin"); //資料庫指令的查詢
                echo "<table border=2><tr><th>佈告編號</th><th>佈告類別</th><th>標題</th><th>佈告內容</th><th>發佈時間</th></tr>"; //建立一個表骨
